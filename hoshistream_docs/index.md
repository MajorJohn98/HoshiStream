...
- [plans/2026-09-12-playback-pointer-library-expansion-plan.md](plans/2026-09-12-playback-pointer-library-expansion-plan.md) — Fifteen-phase expansion (1, 2, 4, 5, 6, 7, 8, 9, 10, 12, 14 done): playback telemetry and buffer-ahead gate, bitrate-aware streams, pointer drift detection, watched state, subtitles, mapping repair, disk-copy policies, diagnostics, TorrServer settings UI, signing and CI smoke, plus Stremio protocol coverage (rich title and episode metadata, thumbnails, stream descriptions, Board rows).
...
- [changelog/0.15.0-library-expansion.md](changelog/0.15.0-library-expansion.md) — Release 0.15.0: disk-copy rolling windows, redacted diagnostics bundle, TorrServer tuning form, Board rows and add-on identity, episode titles/overviews/thumbnails and the Ongoing flag (expansion plan Phases 8, 9, 10, 13, 15).
